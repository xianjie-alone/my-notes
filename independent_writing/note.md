...
- Templet
  ...
  - 对方的事实/现象/细节
    ...
    ==It is hard to deny that (对方的细节）and such a fact may mislead impressionable people to generate the opinion that **(opposite response)**==
  ...
  - 从以下分论点中，我觉得我的意见是跟你不一样的，是…
    ...
    ==As far as (Point1), (Point 2), and (Point 3) are concerned, I strongly hold that (our response).==
...
- Template
  ...
  - First and foremost/First of all, (**Point1**), as (**Fact1**).   <span style="color:green">High</span>
  ...
  - Meanwhile, (**Fact 2**);   <span style="color:green">Mid</span>
  ...
  - Not to mention that (**Fact 3**).  <span style="color:green">Detail</span>
  ...
  - <span style="font-size:1rem; background:pink;">(This is exactly the reason why we should spend more in education.)</span>
...
- Example
  ...
  - **Your concession**: <span style="color:red">**Yes**</span>, gods can bit and defend you.
...
This is not a perfect article! I estimate that this one will score around 26 in a real test. It is posted only for study purposes. I will later post more high-scoring essays : )
